...
public class CustomViews {
    ...
    public static final String PropName=Const.BaseProp + Const.PropDivider + "CustomViews";
    public static final String PathFiltersPropName = Const.BaseProp + Const.PropDivider + "PathFilters";
...
//            
//
//            String OldCVPropName = Const.BaseProp + Const.PropDivider + name;
//            String NewCVPropName = Const.BaseProp + Const.PropDivider + ElementNew;
...
//        String ViewType = View;
//        if (ViewType.contains("&&")) {
//            ViewType = Flow.GetFlowType(ViewType);
...
//        }
//        //String Element =ViewName + "&&" + ViewType;
//        String OldCVPropName = Const.BaseProp + Const.PropDivider + Element;
//        String CurrElements = util.GetProperty(PropName, "");
