...
//
//		Object[] MediaObjectsArray = utility.toArray(MediaObjects);
//
...
//	}
	 ...
	 */
	{
        ...
        public static Object GetLastRecorded(Object MediaObjects){
        MediaObjects = Database.Sort(MediaObjects,true,"PloxeeTV_MetadataCalls_GetOriginalAirDate");
        boolean IsRecorded=false;
          Object currfile = null;
        int i=0;
        while(!IsRecorded){
        currfile = Utility.GetElement(MediaObjects, i);
        if(currfile!=null){
        IsRecorded =MediaFileAPI.IsTVFile(currfile);
        i++;}
        else{
        return null;}}
        return currfile;
        ...
        public static Object GetNewestEpisode(Object MediaObjects){
         MediaObjects = Database.Sort(MediaObjects,true,"GetAiringStartTime");
          return Utility.GetElement(MediaObjects, 0);
        }
...
//		Object[] Arr0 = utility.toArray(MediaObjects);
//
